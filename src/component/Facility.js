...
function Facility() {
  return (
    <>
      ...
      <section className={styles.middlesection}>
        ...
        <div className={styles.text}>
          ...
          <p>
            <b>Main Hall</b>
            <br />
            The Main Hall, which was built in 2017, measures 254m2 in total. It
            has modern audio- visual technology including high quality
            ...
            <b>Class Rooms</b>
            <br />
            Various class rooms of various sizes are available. All have
      ...
      <div className={styles.middsection}>
        <p>
          <b>COMPUTER LAB CUM DIGITAL LARNING</b>
          <br />
          <br />
          USN has setup the State-of-the-Art Computer Lab. and pa, special
          attention to computer training and all the students from className I
          onwards are taught computer skills in a practical and appealing way.
          Internet training forms a core component of learning IT skills.
          Additionally, the students are given the opportunity to master a
          variety of operating systems and application software which are widely
          used in the IT world today. A dedicated Computer lab is avilable to
          all tudents. <br />
        </p>
      ...
      <div className={styles.middsection}>
        <p>
          ...
          <br />
          USN is a next Residential-cum-Day School where Boarding homes plays a
          key role in the overall development of children staying away from
          their homes. In all respects, it is a second home away from home,
          enabling the boarders to use it as a springboard to success and a
          stepping stone to enter the world with confidence, dignity, sportsman
          spirit and wisdom.
        </p>
        <div className={styles.i1}>
          <img src={f7} alt="pic" />
      ...
      <div className={styles.middsection}>
        <p>
          ...
          <br />
          The M.U.G.A., which was installed in 2018, is surrounded by solid
          fencing. It measures 1268m2 in total. It is marked out for a range of
          sports.
          <br />
          <br />
          <b>JOGA EDUCATION</b>
      ...
      <div className={styles.middsection}>
        <p>
          ...
          notified by the school authorities from time to time. The bus fee is
          payable for all the 12 months of a year. Pupil will be dropped only at
          the predetermined alighting point. A guardian cannot personally
          collect a pupil availing of school transport except in an emergency.
          In such a case, a request should be made in writing to the Principal
          to permit the guardian concerned to personally collect his/her ward
          from the School by 9.00 a.m. on the concerned day. However, no pupil
          will be handed over to an escort unless the relevant ID card is
          produced.
        </p>
        <div className={styles.i1}>
          <img src={f9} alt="pic" />
